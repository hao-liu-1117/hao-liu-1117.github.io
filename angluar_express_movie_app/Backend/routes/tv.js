...
router.get('/top', (req, res) => {
  let url = "https://api.themoviedb.org/3/tv/top_rated?api_key=" +
            api_key +
            "&language=en-US&page=1";
  axios.get(url).then(posts => {
    let data = posts.data.results;
...
router.get('/trending', (req, res) => {
  let url = "https://api.themoviedb.org/3/trending/tv/day?api_key=" +
            api_key +
            "&language=en-US&page=1";
  axios.get(url).then(posts => {
    let data = posts.data.results;
...
router.get('/details/:id', (req, res) => {
  ...
  axios.get(url).then(posts => {
    ...
    ret['release_date'] = data['first_air_date'].substr(0,4);
    mins = data['episode_run_time'];
